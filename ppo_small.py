...
from env import AllostaticEnv
from util import layer_init, BetaHead, test_env, NewGELU
...
if __name__ == "__main__":
    args = parse_args()
    run_name = f"allostasis__{args.exp_name}__{args.seed}__{int(time.time())}"
    ...
    file_name = f"saved_models/{run_name}_final.pth"
